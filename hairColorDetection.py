...
class hairColorDetection():
    ...
    def __init__(self, img: np.ndarray) -> None:
        ...
        self.colorNamesDf = pd.read_csv(r'data\hairColors.csv', names=index, header=None)
        
        # Img
        self.img = cv2.GaussianBlur(img, (5, 5), 0)
        
        # Classifier
        self.classifierPath = 'facesClassifier.xml'


    def findFace(self) -> tuple | None:
